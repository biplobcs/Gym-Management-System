...
if (isset($_REQUEST["submit"])) {
    ...
    if($query1){
        echo"<script>alert('Data Upoaded Sucessfully');</script>";
    }
    else{
        echo"<script>alert('Data not Upoaded');</script>";
    }
}
?>
...
<div class="collapse navbar-collapse" id="navbarNav">
    <ul class="navbar-nav">
      <li class="nav-item active">
        <a class="nav-link" href="index.html">Gym Mananagement System</a>
      </li>
      <li class="nav-item">
...
<form>
  ...
  <div class="form-group">
    ...
    <input type="date" name="date" class="form-control" id="inputAddress" placeholder="date">
  </div>
  <div class="form-group">
