...
if (isset($_POST["register"])) {
    ...
    $ins = "INSERT INTO services (name,password,transaction) VALUES ('$name','$hash','$transaction')";
			...
			<div class="left">
				...
				<div class="contact">
					<form action="#" method="post">
						...
						<input type="text" name ="transaction"placeholder="Transaction Number">
            <button class="submit" name="register" value="register" >SUBMIT</button>
					</form>
				</div>
			</div>
			<div class="right">
